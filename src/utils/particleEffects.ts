/**
 * PARTIAL MIGRATION: Re-exporting completed particle modules from /animation/
 * 9/25 particles have been extracted to modular files
 * The remaining 16 particles are still defined below in this file
 *
 * Note: Interface types are still defined below for backwards compatibility
 */

// Core particles (4/4 complete)
export {
  initMoonFlashes,
  spawnMoonFlash,
  drawMoonFlashes,
...
// Atmospheric particles (4/4 complete)
export {
  initAuroraWaves,
  drawAurora,
...
// Legendary particles (1/7 complete)
export {
  initBloodRings,
  drawBloodRings,
