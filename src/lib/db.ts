...
export async function cacheDreamLogs(logs: any[]): Promise<void> {
...
export async function getCachedDreamLogs(): Promise<any[]> {
  const db = await getDB();
...
export async function cacheSleepLogs(logs: any[]): Promise<void> {
  const db = await getDB();
...
export async function getCachedSleepLogs(): Promise<any[]> {
  const db = await getDB();
